...
export const getProduct =
  (keyword = "", price = [0, 150000], category, ratings = 0, page = 1) =>
  async (dispatch) => {
    try {
      ...
      if (category) {
        link = `/api/v1/products?keyword=${keyword}&price[gte]=${price[0]}&price[lte]=${price[1]}&category=${category}&ratings=${ratings}&page=${page}`;
      }
